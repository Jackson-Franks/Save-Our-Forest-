...
export default class Ui extends Phaser.Scene
{
	...
	create()
	{
        ...
        this.hearts.scaleXY(.1, .1)
        
        

		sceneEvents.on('player-damage', this.handlePlayerHealthChanged, this)

		this.events.once(Phaser.Scenes.Events.SHUTDOWN, () => {
			sceneEvents.off('player-damage', this.handlePlayerHealthChanged, this)
